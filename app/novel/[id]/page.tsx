        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          {chapters.map((chap) => (
            <Link
              ...
              className="p-3.5 bg-gray-900 border border-gray-800 rounded-lg hover:border-blue-500 hover:bg-gray-800/80 transition text-sm text-gray-200 font-medium flex items-center justify-between group"
            >
